...
class StockMarket:
    def __init__(self):
        ...
        self.function = os.environ.get("FUNCTION")
        self.base_url = "https://www.alphavantage.co/query"
        self.symbols = ["AAPL", "GOOG", "IBM"]
        self.limitation = {"advanced analytics": 5, "time delay limit": 12}

    def execute(self):

        params = {"function": function, "symbol": self.symbols, "apikey": self.api_key}
        try:
